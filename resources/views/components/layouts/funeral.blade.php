...
<head>
    ...
    <style>
        ...
        .navbar-brand, .nav-link, .dropdown-toggle { color: #f8f9fa !important; }
        .nav-link.active, .nav-link:hover { color: #ffc107 !important; }
        header, footer { background-color: #1f2937; }
        footer { color: #aaa; }
        .sidebar {
            min-height: 100vh;
            background: #1f2937;
        ...
        .sidebar .nav-link { color: #f8f9fa !important; }
        ...
        .sidebar .sidebar-heading {
            ...
            letter-spacing: 1px;
            padding: 0.7em 1.1em 0.25em 0.9em;
            font-weight: 600;
        }
    ...
    <div class="row flex-nowrap">
        ...
        <div id="sidebar" class="col-auto col-md-3 col-lg-2 px-sm-2 px-0 sidebar d-flex flex-column show-sidebar">
            <ul class="nav nav-pills flex-column mb-auto py-4">
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link {{ request()->routeIs('funeral.assets.reservations.index') ? 'active' : '' }}"
                        href="{{ route('funeral.assets.reservations.index') }}">
                        <i class="bi bi-truck me-2"></i> Asset Booking Management
                    </a>
                </li>
                ...
                <div class="sidebar-heading">Partnerships & Assets</div>
                <li class="nav-item mb-2">
                    <a class="nav-link {{ request()->routeIs('funeral.partnerships.index') ? 'active' : '' }}"
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link {{ request()->routeIs('funeral.profile.*') ? 'active' : '' }}"
                        ...
                        <i class="bi bi-person me-2"></i> Funeral Parlor Profile
                    </a>
                </li>
            </ul>
        </div>
