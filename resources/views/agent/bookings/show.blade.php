...
.timeline-item:last-child {
    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <a href="{{ route('agent.dashboard') }}" class="btn btn-link mb-3">
...
<div class="mb-3 d-flex justify-content-end align-items-center gap-2" style="min-height:42px;">
    {{-- Export PDF --}}
    <a href="{{ route('agent.bookings.exportPdf', $booking->id) }}"
    ...
    @if($booking->certificate_released_at && $booking->certificate_signature)
        <a href="{{ route('agent.bookings.download-certificate', $booking->id) }}"
    ...
    @if(in_array($booking->status, ['confirmed', 'for_initial_review', 'in_progress', 'for_review']))
        <a href="{{ route('agent.bookings.editBooking', $booking->id) }}"
    ...
    {{-- Edit Deceased Info --}}
    @if(in_array($booking->status, ['in_progress', 'for_review']))
        <a href="{{ route('agent.bookings.editInfo', $booking->id) }}"
    ...
    @if($booking->status === 'pending_payment')
        <a href="{{ route('agent.bookings.payment', $booking->id) }}"
...
<dl class="row mb-4">
    ...
    <dd class="col-sm-7">
        ...
        @endif
                        ...
                        <a href="{{ route('agent.dashboard') }}" class="btn btn-outline-secondary rounded-pill mt-3 px-4 py-2">
                            <i class="bi bi-arrow-left"></i> Back to Dashboard
                        </a>
                    </div>
                </div>
