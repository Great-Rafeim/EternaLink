{{-- resources/views/cemetery/dashboard.blade.php --}}
...
<x-cemetery-layout>
    ...
    @if(isset($cemeteryMissing) && $cemeteryMissing)
        <div class="alert alert-warning">
            <strong>No cemetery profile is linked to your account.</strong><br>
