                                    ...
                                    <div class="card shadow-lg border-0 rounded-4 p-4">
                                        ...
                                        <div class="mb-3 row align-items-center" style="min-height:42px;">
                                            ...
                                            <div class="col">
                                                ...
                                                @endif
                                               {{-- 2nd set: Service Start (if status is "approved") --}}
                                                ...
                                                @endif
                                                    ...
                                                    <div class="col-auto d-flex gap-2 justify-content-end">
                                                        <a href="{{ route('funeral.bookings.exportPdf', $booking->id) }}"
                                                        class="btn btn-outline-primary"
                                                        target="_blank">
                                                            <i class="bi bi-filetype-pdf"></i> Export as PDF
                                                        </a>
                                                @if($booking->status === 'pending_payment')
                                                    <a href="{{ route('funeral.bookings.payment', $booking->id) }}"
                                                ...
                                                {{-- 2nd set: Approve/Deny (if status is "paid") --}}
                                                ...
                                                {{-- New set: Initial Review (if status is "for_initial_review") --}}
                                                @if($booking->status === 'for_initial_review')
                                                    <form action="{{ route('funeral.bookings.approve', $booking->id) }}" method="POST" class="d-inline-block">
                                                        @csrf
                                                        @method('PATCH')
                                                        <button type="submit" class="btn btn-success rounded-pill px-4 mb-2">
                                                            <i class="bi bi-check2-circle"></i> Approve
