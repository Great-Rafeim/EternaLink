...
<div class="col-md-3">
    ...
    @endphp
    <select name="informant_civil_status" class="form-select" >
...
<div class="col-md-3">
    ...
    @endphp
    <select name="informant_relationship" class="form-select" >
...
<div class="card mb-4 border-0">
    ...
    <div class="card-body row g-3">
        <div class="col-md-4">
            ...
            <input name="service" type="text" class="form-control" value="{{ old('service', $packageName) }}" >
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            ...
            <input name="other_fee" id="other_fee" type="number" step="0.01" min="0" class="form-control"
                value="{{ old('other_fee', $detail->other_fee ?? '') }}" >
        </div>
        ...
        <div class="col-md-12">
            ...
            <textarea name="remarks" class="form-control" rows="2">{{ old('remarks', $detail->remarks ?? '') }}</textarea>
        </div>
    </div>
</div>
